...
class General(commands.Cog, name="general"):
    ...
    @commands.hybrid_command(
        name="maple",
        description="Give me your IGN. Tell me if you want it to kittify, mount, have it animated or hair color or any expression changes",
    )
    @checks.not_blacklisted()

    async def maple_command(self, context: Context, *, input_str: str) -> None:
        from kittify import get_avatar_image , parse_input_string
